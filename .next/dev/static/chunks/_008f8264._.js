...
function LoginPage() {
    ...
    const { signIn, isLoaded, setActive } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$clerk$2d$react$2f$dist$2f$chunk$2d$F54Q6IK5$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["useSignIn"])();
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            if (result.status === 'complete') {
                ...
                // After setting active, the user should be available in the global Clerk object
                // Wait a bit for Clerk to update
                await new Promise((resolve)=>setTimeout(resolve, 1000));
                // Try to get user ID from multiple sources
                let clerkUserId = clerkUser?.id;
                // If still not available, try from window.Clerk
                if (!clerkUserId && ("TURBOPACK compile-time value", "object") !== 'undefined' && window.Clerk) {
                    clerkUserId = window.Clerk.user?.id;
                }
                console.log('Clerk User ID:', clerkUserId);
                console.log('Clerk User Object:', clerkUser);
                if (!clerkUserId) {
                    // If we still don't have the user ID, redirect to dashboard
                    // The page will handle authentication check
                    console.log('Redirecting to dashboard - user ID will be available there');
                    router.push('/dashboard');
                    return;
                }
                // Step 1: Check if user exists in database
                const userExistsResponse = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$api$2f$token$2d$user$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["checkUserExists"])(clerkUserId);
                ...
                const tokenResponse = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$api$2f$token$2d$user$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generateToken"])(clerkUserId);
                if (!tokenResponse.success || !tokenResponse.data?.token) {
                    throw new Error(tokenResponse.message || 'Failed to generate authentication token');
                }
                const { token, user } = tokenResponse.data;
                // Step 3: Store token in cookies
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$api$2f$token$2d$user$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storeTokenInCookies"])(token);
                // Step 4: Get full user profile to verify status
                const profileResponse = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$api$2f$token$2d$user$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getUserProfile"])(token);
                if (!profileResponse.success || !profileResponse.data) {
                    throw new Error('Failed to retrieve user profile');
                }
                const userProfile = profileResponse.data;
                // Step 5: Verify user is MASTER_NODE
                if (userProfile.role !== 'MASTER_NODE') {
                    setError('Access denied. This portal is only for Master Node users.');
                    setLoading(false);
                    return;
                }
                // Step 6: Check if user status is active
                ...
                setError(`Login status: ${result.status}. Please try again or contact support.`);
            }
        } catch (err) {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    type: "submit",
                                    disabled: loading,
                                    className: "w-full bg-linear-to-r from-blue-600 to-purple-600 text-white py-3 px-4 rounded-lg font-semibold hover:from-blue-700 hover:to-purple-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all disabled:opacity-50 disabled:cursor-not-allowed",
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                    ...
                    children: "Secure Master Node Portal • AuramX Investment Platform"
                }, void 0, false, {
                    fileName: "[project]/app/login/page.tsx",
                    lineNumber: 265,
                    columnNumber: 9
...
_s(LoginPage, "tXrwOgUf+aWKAfuMbN6aJEEWAC4=", false, function() {
    return [
...
//# sourceMappingURL=_008f8264._.js.map