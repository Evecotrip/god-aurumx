...
function SettingsPage() {
    ...
    const [activeTab, setActiveTab] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('bank');
    ...
    // Daily Rate States
    const [rateStatus, setRateStatus] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    // Bank Account Form
    const [bankFormData, setBankFormData] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        accountName: '',
        accountHolder: '',
        bankName: '',
        accountNumber: '',
    ...
    // Daily Rate Form
    const [rateFormData, setRateFormData] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SettingsPage.useEffect": ()=>{
            const initializeToken = {
                "SettingsPage.useEffect.initializeToken": async ()=>{
            ...
            }["SettingsPage.useEffect.initializeToken"];
    ...
    const fetchBankAccounts = async ()=>{
        if (!token) return;
        setLoading(true);
        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$api$2f$currency$2d$bank$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAllBankAccounts"])(token);
    ...
    const fetchRateStatus = async ()=>{
        if (!token) return;
        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$api$2f$currency$2d$bank$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDailyRateStatus"])(token);
        if (response.success && response.data) {
    ...
    const handleCreateBankAccount = async ()=>{
        ...
        setError('');
        setSuccess('');
        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$api$2f$currency$2d$bank$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createBankAccount"])(token, bankFormData);
        if (response.success) {
    ...
    const handleUpdateBankAccount = async ()=>{
        ...
        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$api$2f$currency$2d$bank$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateBankAccount"])(token, selectedAccount.id, updatePayload);
        if (response.success) {
    ...
    const handleUploadQR = async (accountId)=>{
        ...
        setUploadingQR(true);
        setError('');
        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$api$2f$currency$2d$bank$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["uploadBankQRCode"])(token, accountId, qrFile);
        if (response.success) {
    ...
    const handleDeleteBankAccount = async ()=>{
        ...
        setLoading(true);
        setError('');
        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$api$2f$currency$2d$bank$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deactivateBankAccount"])(token, selectedAccount.id);
        if (response.success) {
    ...
    const handleSetDailyRate = async ()=>{
        ...
        setLoading(true);
        setError('');
        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$api$2f$currency$2d$bank$2d$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setDailyProfitRate"])(token, rateFormData);
        if (response.success) {
                ...
                children: [
                    ...
                    activeTab === 'bank' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                        children: [
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                                ...
                                                children: [
                                                    ...
                                                    account.qrCodeUrl && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        className: "flex items-center gap-2 text-sm",
                                                        children: [
                            ...
                            bankAccounts.length === 0 && !loading && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                        children: rateStatus?.todayRate ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: "space-y-4",
                                            children: [
                                                rateStatus.fallbackUsed && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                rateStatus.todayRate.notes && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                    className: "text-sm text-muted-foreground",
                                                    children: [
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    selectedAccount.qrCodeUrl && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "mt-3",
...
_s(SettingsPage, "y7eFn5H7IaAZJC3ti8l4padd6kM=", false, function() {
    return [
...
//# sourceMappingURL=_efe38511._.js.map